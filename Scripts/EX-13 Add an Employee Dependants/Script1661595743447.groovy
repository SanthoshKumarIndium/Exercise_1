...
WebUI.click(findTestObject('Page_Depandant/a_Dependents'))

WebUI.click(findTestObject('Page_Depandant/button_Add'))
...
WebUI.click(findTestObject('Page_Depandant/button_Save'))
