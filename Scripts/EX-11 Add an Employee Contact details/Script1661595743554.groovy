...
WebUI.setText(findTestObject('Page_Contactdetails/input_City_oxd-input oxd-input--focus'), GlobalVariable.city)

WebUI.setText(findTestObject('Page_Contactdetails/input_StateProvince_oxd-input oxd-input--focus'), GlobalVariable.state)
