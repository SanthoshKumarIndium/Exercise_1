...
WebUI.click(findTestObject('Recruit/Page_Recruit/button_Mark Interview Passed'))

WebUI.setText(findTestObject('Recruit/Page_Recruit/notes_Interviewpassed'), GlobalVariable.notesInterviewStatus)
