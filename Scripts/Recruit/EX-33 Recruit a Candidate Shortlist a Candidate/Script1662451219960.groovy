...
WebUI.click(findTestObject('Recruit/Page_Recruit/button_Shortlist'))

WebUI.setText(findTestObject('Recruit/Page_Recruit/notes_shortlist'), GlobalVariable.NotesShortlist)
