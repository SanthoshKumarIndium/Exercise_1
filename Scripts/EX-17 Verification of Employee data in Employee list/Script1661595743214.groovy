...
WebUI.click(findTestObject('Page_Employee list/li_Employee List'))
...
WebUI.verifyElementText(findTestObject('Page_Employee list/div_firstname'), GlobalVariable.Firstname)
